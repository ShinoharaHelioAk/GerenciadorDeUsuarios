...
@WebServlet(name = "ativaUsuarioServlet", urlPatterns = "/ativaUsuario")
public class AtivaUsuarioServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		out.println("<html>");
		out.println("<head><title>SGUSR - Usuário Ativado com Sucesso!</title></head>");
		out.println("<body>");
		out.println("<h3>Usuário Ativado com Sucesso!</h3>");
